...
public class ActivityFindAnimals extends AppCompatActivity {
    ...
    private void speak(String txtEnter) {
        String text = txtEnter;
    ...
    public void gameRestart() {
        ...
        imgViewCheck0FindAnimals.setImageResource(R.drawable.ic_launcher_incheck_trans);
        imgViewCheck1FindAnimals.setImageResource(R.drawable.ic_launcher_incheck_trans);
        imgViewCheck2FindAnimals.setImageResource(R.drawable.ic_launcher_incheck_trans);
    ...
    public void correctAnswer(int corAnswer) {
        //setGameLevel(1);
        if (corAnswer == 1) {
            imgViewCheck0FindAnimals.setImageResource(R.drawable.ic_launcher_check_trans);
            tblLayoutFindAnimals.removeAllViews();
            stopPlayer();
        }
        if (corAnswer == 2) {
            imgViewCheck1FindAnimals.setImageResource(R.drawable.ic_launcher_check_trans);
            tblLayoutFindAnimals.removeAllViews();
            stopPlayer();
        }
        ...
        if (corAnswer == 3) {
            ...
            waiter.setWaitListener(new WaitListener() {
                ...
                public void checkCondition() {
                    imgViewCheck2FindAnimals.setImageResource(R.drawable.ic_launcher_check_trans);
                }
